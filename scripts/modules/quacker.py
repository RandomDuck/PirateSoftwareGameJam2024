...
class Quacker(Page):
  ...
  def setup(self):
    ...
    self.sell = TextButton((self.pos[0]+10, self.pos[1]+110),"Post fake news (-10 follows, +20 cash)",(self.size[0]-20,60),((255,255,0),(255,0,0)),(100,100,100),(True,True), lambda:self.sellFollows())
    self.elements.append(self.banner)
    self.buttons.append(self.post)
    self.buttons.append(self.sell)
  ...
  def update(self, area):
    ...
    self.sell.update((self.pos[0]+10, self.pos[1]+110),(self.size[0]-20,60))