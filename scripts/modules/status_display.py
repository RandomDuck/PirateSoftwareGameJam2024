...
class Status:
  ...
  def setup(self):
    ...
    self.moral = Tb(pos[0], size[0], f'FPS: {self.gameCon.getClicksPerSecond()}', textColor, backgroundColor, textCentering, textsize)
  ...
  def updateText(self):
    self.moral.text = f'FPS: {self.gameCon.getClicksPerSecond()}'
